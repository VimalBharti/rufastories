<template>
  <div>
    <!-- Hero Area -->
    <div class="header max-h-[60vh] h-full relative">
      ...
      <div class="hero-area h-full relative overflow-hidden">
        <img src="/images/nature.jpg" alt="nature-background-midjourney" class="h-full w-full object-cover">
     ...
     <!-- Categories -->
     <section class="pb-10 px-4 md:px-0 -mt-[3vh] relative">
    ...
    <section class="h-full w-full py-10 px-4 md:px-0 shadow">
      <div class="max-w-7xl mx-auto">
        <div class="flex items-center justify-between">
          ...
          <button class="text-sm bg-zinc-800 rounded-lg text-white px-3 py-1 flex items-center gap-1">
            View all
            <Icon name="ic:round-arrow-right-alt" class="w-4 h-4" />
          </button>
        </div>
        <div class="grid grid-cols-1 md:grid-cols-3 gap-4 mt-5">
          ...
          <div class="relative flex w-full flex-col overflow-hidden rounded-lg border border-gray-100 bg-white shadow-md" v-for="product in products" :key="product.id">
            ...
            <div class="mt-4 px-5 pb-5">
              <a href="#">
                <h5 class="text-sm tracking-tight text-slate-900">{{ product.name }}</h5>
              </a>
